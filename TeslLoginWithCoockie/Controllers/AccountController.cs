...
using TeslLoginWithCoockie.ViewModels;
...
namespace TeslLoginWithCoockie.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserContext context, IHttpContextAccessor httpControllerAccessor)
        {
            db = context;
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    db.Users.Add(new User { Name = model.Name, Surname = model.Surname, Email = model.Email, Password = model.Password,RegistrationDate = DateTime.Now});
